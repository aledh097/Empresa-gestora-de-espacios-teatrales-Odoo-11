...
class espectaculo(models.Model):
    ...
    productor = fields.Char('Productor', size=64, required=True)
    categoria = fields.Selection([('teatro clásico','Teatro Clásico'),
                                     ...
                                     'Categoría')
    gastos = fields.Float('Gastos',required=True)
    representacion_ids = fields.One2many('upoteatro.representacion','espectaculo_id', 'Representaciones',required=True)
